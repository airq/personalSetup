...
parser.add_option('-m','--nodata',
                  dest   = 'data',
                  action = 'store_false',
                  help   = 'generate mesh without microstructure index data [%default]')
parser.add_option('-t','--type',
                  dest   = 'type',
                  action = 'store_false',
                  help   = 'the displayed data is integer? [%default]')
...
#--- read microstructure information --------------------------------------------------------------
  ...
  if options.data:
    ...
    if ok:
      structure = vtk.vtkIntArray() if options.type else vtk.vtkDoubleArray()
